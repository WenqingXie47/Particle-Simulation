...
parser.add_argument('--num-valid', type=int, default=2500,
...
parser.add_argument('--n_observed', type=int, default=5,
                    help='Number of balls in the simulation.')
parser.add_argument('--n_unobserved', type=int, default=1,
                    help='Number of balls in the simulation.')
